...
class TestCli(object):
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_lock(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_unlock(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    def test_describe_resources_recursive(self, mock_get_env, mock_getcwd):
        describe_response = {
            "stack-name-1": {
                "StackResources": [
                    {
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_describe_resources(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
        describe_response = {
            "StackResources": [
                {
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_create(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_delete(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_update(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_launch(self, mock_get_stack, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_env")
    def test_launch_recursive(self, mock_get_env, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2._get_env")
    def test_launch_recursive_returns_zero_correctly(self, mock_get_env):
    ...
    @patch("sceptre.cli_v2._get_env")
    def test_launch_recursive_returns_non_zero_correctly(self, mock_get_env):
        mock_get_env.return_value.launch.return_value = dict(
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_env")
    def test_delete_recursive(self, mock_get_env, mock_getcwd):
        mock_getcwd.return_value = sentinel.cwd
    ...
    @patch("sceptre.cli_v2._get_env")
    def test_delete_recursive_returns_zero_correctly(self, mock_get_env):
    ...
    @patch("sceptre.cli_v2._get_env")
    def test_delete_recursive_returns_non_zero_correctly(self, mock_get_env):
        mock_get_env.return_value.delete.return_value = dict(
            (sentinel.stack_name, StackStatus.FAILED) for _ in range(5)
        )
        result = self.runner.invoke(
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_stack")
    def test_describe_change_set_verbose(
    ...
    @patch("sceptre.cli_v2.os.getcwd")
    @patch("sceptre.cli_v2._get_env")
    def test_set_policy_with_file_flag(
        self, mock_get_env, mock_getcwd
    ):
        mock_getcwd.return_value = sentinel.cwd
        self.runner.invoke(cli, [
            "set-policy", "config/dev/vpc.yaml",
    ...
    @patch("sceptre.cli_v2._get_env")
    def test_get_policy_with_existing_policy(self, mock_get_env):
        ...
        result = self.runner.invoke(
            cli, ["get-policy", "config/dev/vpc.yaml"])
        assert result.output == "policy\n"

    @patch("sceptre.cli_v2._get_env")
    def test_get_policy_without_existing_policy(
            self, mock_get_env
    ):
        mock_get_env.return_value.stacks["vpc"].get_policy\
            .return_value = {}
